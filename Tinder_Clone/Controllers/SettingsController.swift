...
class SettingsController: UITableViewController {
  ...
  lazy var header: UIView = {
    ...
    stackView.anchor(top: header.topAnchor, leading: nil, bottom: header.bottomAnchor, trailing: header.trailingAnchor, padding: .init(top: padding, left: 0, bottom: padding, right: 50))
    return header
  }()
  ...
  var logoutButton: UIButton {
    let button = UIButton(type: .custom)
    button.tintColor = #colorLiteral(red: 0.6000000238, green: 0.6000000238, blue: 0.6000000238, alpha: 1)
    button.setImage(#imageLiteral(resourceName: "user").withRenderingMode(.alwaysTemplate), for: .normal)
